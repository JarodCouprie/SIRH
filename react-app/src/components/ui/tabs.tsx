...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex items-center justify-center rounded-lg bg-gray-200 p-1 text-gray-500 dark:bg-gray-900 dark:text-gray-400",
      className,
    )}
    {...props}
  />
