...
VALUES ("TRAVEL", 300, "Voyage d'affaire", "WAITING", 2, null, '2024-09-01'),
       ("COMPENSATION", 50, "Indemnisation", "REFUNDED", 2, 1, '2023-09-01'),
       ("FOOD", 100, "Repas pro", "WAITING", 1, null, '2024-09-01'),
       ("HOUSING", 149, "Hotel", "WAITING", 1, null, '2024-09-01'),
       ("TRAVEL", 300, "Voyage d'affaire", "WAITING", 2, null, '2024-03-11'),
       ("COMPENSATION", 50, "Compensation accident", "REFUNDED", 2, 1, '2024-09-02'),
       ("FOOD", 102, "Repas pro", "WAITING", 1, null, '2024-04-15'),
       ("HOUSING", 149, "Hotel", "WAITING", 1, null, '2024-04-01'),
       ("TRAVEL", 300, "Voyage d'affaire", "WAITING", 2, null, '2024-03-11'),
       ("COMPENSATION", 89, "Prime", "REFUNDED", 2, 1, '2023-09-01'),
       ("FOOD", 20.99, "Restauration en déplacement", "NOT_REFUNDED", 1, null, '2024-09-01'),
       ("COMPENSATION", 20.99, "Raison non valide", "NOT_REFUNDED", 2, null, '2024-09-01'),
       ("FOOD", 20.99, "Restauration en déplacement", "NOT_REFUNDED", 2, null, '2024-09-01'),
       ("HOUSING", 149, "Hotel", "NOT_REFUNDED", 1, null, '2024-09-03'),
       ("TRAVEL", 300, "Voyage d'affaire", "REFUNDED", 2, 1, '2024-09-03'),
       ("COMPENSATION", 50, "Indemnisation", "REFUNDED", 2,1, '2023-09-01'),
       ("TRAVEL", 300, "Voyage d'affaire", "REFUNDED", 1, 2, '2024-09-03'),
       ("COMPENSATION", 50, "Indemnisation", "REFUNDED", 1, 2, '2023-09-01'),
